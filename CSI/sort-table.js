...
sortTable.init = function() {
    ...
    for (var i = 0; i < Tables.length; i++) {
        ...
        if (!document.querySelectorAll && null === Tables[i].className.match(/\btable\b/)) {
            continue;
        }

        // Prevent repeat processing
        if (Tables[i].attributes['data-table']) {
            continue;
        }
        ...
        Tables[i].setAttribute('data-table', 'true')
    }
    ...
    sheet.insertRule('table.table.js-sort-asc thead tr > .js-sort-active:not(.js-sort-none):after {content: "\\25b2";font-size: 0.7em;padding-left: 3px;line-height: 0.7em;}', 0);
    sheet.insertRule('table.table.js-sort-desc thead tr > .js-sort-active:not(.js-sort-none):after {content: "\\25bc";font-size: 0.7em;padding-left: 3px;line-height: 0.7em;}', 0);
};
